...
\begin{document}
  ...
  \section*{Experimental Plan}
  	...
  	\begin{enumerate}
  		\item
  		We plan to research natural language resource issues. Our goal is to extend our ontology using Leixon entries, NL Names and Sentence Plans.
  		We would like to explore text generation using NL resources, and the effect of of enriching these resources on the generated text.
  		We will be documenting our steps and results throughout this process so that we have sufficient information to make informal evaluations 
  		and educated guesses.

  		\item
  		Our primary domain ontology is a US Military Knowledge Base focusing on the World Wars.
